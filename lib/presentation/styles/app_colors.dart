...
class AppColors {
  ...
  static const Color primary = Color(0xFFFF7562);
  static const Color background = Color(0xFFDEDECE);
  static const Color action = Color(0xFF650C01);
  static const Color highlight = Color(0xFFC67C72);
